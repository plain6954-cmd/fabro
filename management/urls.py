...
from .api_views import (
    ...
    ComplaintSubmitExecutionVerificationAPIView,
...
urlpatterns = [
    ...
    path('api/approvals/quick-decide/<int:approval_id>/', views.quick_approval_decision_api, name='quick_approval_decision_api'),
    ...
    path('api/chat/users/', views.chat_users_api, name='chat_users_api'),
    path('api/chat/messages/<int:user_id>/', views.chat_messages_api, name='chat_messages_api'),
    ...
    path('api/next-pattern-serial/', views.get_next_pattern_serial_api, name='get_next_pattern_serial_api'),
    path('api/pattern-vehicles/', views.pattern_vehicle_list_api, name='pattern_vehicle_list_api'),
    path('api/pattern-vehicles/count/', views.pattern_vehicle_count_api, name='pattern_vehicle_count_api'),
    path('api/year-range/<int:year_range_id>/update-fitting/', views.update_fitting_confirmation_api, name='update_fitting_confirmation_api'),
    path('api/patterns/bulk-delete/', views.bulk_delete_patterns_api, name='bulk_delete_patterns_api'),
    path('api/pattern-alterations/<int:alteration_id>/decide/', views.decide_pattern_alteration_api, name='decide_pattern_alteration_api'),
    path('api/pattern/<int:year_range_id>/logs/', views.pattern_logs_api, name='pattern_logs_api'),
    path('api/design-folders/', views.get_design_folders_api, name='get_design_folders_api'),
    path('api/design-folders/create/', views.create_design_folder_api, name='create_design_folder_api'),
    path('api/design-folders/<int:folder_id>/', views.get_design_folder_detail_api, name='get_design_folder_detail_api'),
    path('api/design-folders/<int:folder_id>/rename/', views.rename_design_folder_api, name='rename_design_folder_api'),
    path('api/design-folders/<int:folder_id>/delete/', views.delete_design_folder_api, name='delete_design_folder_api'),
    path('api/design-folders/<int:folder_id>/upload/', views.upload_design_images_api, name='upload_design_images_api'),
    path('api/vehicles/<int:vehicle_id>/design-images/upload/', views.upload_vehicle_design_images_api, name='upload_vehicle_design_images_api'),
    path('api/vehicles/<int:vehicle_id>/google-drive/', views.update_vehicle_google_drive_api, name='update_vehicle_google_drive_api'),
    path('api/design-images/<int:image_id>/delete/', views.delete_design_image_api, name='delete_design_image_api'),
    path('design-images/<int:image_id>/download/', views.pattern_design_image_download, name='pattern_design_image_download'),
    ...
    path('api/complaint-types/<str:complaint_type>/', views.get_complaint_type_options, name='get_complaint_type_options'),
    ...
    path('admin-panel/brands/<int:brand_id>/', views.admin_brand_tree, name='admin_brand_tree'),
